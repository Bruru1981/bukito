...
/** Standalone menu content — can be embedded in another section */
export function MenuFoldout() {
      ...
      <div className="max-w-3xl">
          ...
          <AnimatePresence initial={false}>
            {menuOpen && (
              ...
              >
                {/* Chef Ragil — revealed when menu opens */}
                <div className="flex items-center gap-4 mb-8">
                  <div className="relative h-16 w-16 shrink-0 overflow-hidden rounded-full ring-1 ring-sunrust/10">
                    <Image
                  ...
                  <div>
                    <p className="text-sm tracking-[-0.02em]">Chef Ragil</p>
                    <p
                      className="text-[11px] tracking-[0.1em] opacity-25 mt-0.5"
